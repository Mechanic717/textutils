...
export default function About(props) {
  ...
  const myStyle = {
    color: mode === 'dark' ? 'white' : '#36454F',
    backgroundColor: mode === 'dark' ? '#36454F' : 'white',
  };
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              text. TextUtils reports the number of words and characters, making it suitable for writing text with word/character
              limits.
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              is suitable for counting characters in Facebook, blogs, books, Excel documents, PDFs, essays, and more.
            </div>
          </div>
        </div>
      </div>
